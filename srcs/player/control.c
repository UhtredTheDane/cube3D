...
void	move_up(t_canvas *canvas)
{
	//if (canvas->player->y > 0)
		canvas->player->y += canvas->player->dir_y * 0.04;
	//if (canvas->player->x > 0)
		canvas->player->x += canvas->player->dir_x * 0.04;
}
...
{
	//if (canvas->player->y < canvas->map->line_nb * SQUARE)
		canvas->player->y -= canvas->player->dir_x * 0.04;
	//if (canvas->player->x > 0)
		canvas->player->x += canvas->player->dir_y * 0.04;
}
